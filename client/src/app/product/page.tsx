...
function Page({}: Props) {
  return (
    <section className="lg:flex min-h-screen lg:p-4 ">
      ...
      <div className="flex-1 px-4 sm:p-6 lg:p-8 divide-y divide-border/30">
        <div className="w-full lg:w-fit py-4">
          ...
          <div className="w-full pb-4">
            <Button className="w-full rounded-none ">ADD TO BAG</Button>
          </div>
        </div>
        <div className="py-4">
          ...
          <ScrollArea className="md:h-[40vh]">
            <div className="text-muted-foreground text-sm">
              <p className="pb-4">
                ...
                Excepturi eius cumque eos distinctio. Totam, eaque vero fugit
                velit nesciunt eius itaque, vitae ipsam culpa maxime iste magnam
